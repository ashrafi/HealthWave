package com.ylabz.health.wave.client;
 ...
 */
public class HealthWave implements EntryPoint {
	/**
	...
	public void onModuleLoad() {
	    ...
	    hSplit.setLeftWidget(tabPanel);
	    hSplit.setRightWidget(RootPanel.get("waveframe"));
		
		
		RootPanel.get("main").add(hSplit);
